            ...
            <div class="navbar-nav theme-brand flex-row  text-center">
                <div class="nav-logo">
                    <div class="nav-item theme-logo">
                        <a href="index.html">
                            <img src="{{asset('images/indexImages/logo.svg')}}" class="navbar-logo" alt="logo">
                        </a>
                    </div>
        ...
        <div class="container">
            <div class="container">
                ...
                <div class="row layout-top-spacing">
                    <div id="fuMultipleFile" class="col-lg-12 layout-spacing" style="height: 180px;">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area" style="height: 180px;">
                                ...
                                <div class="row">
                                    <form action="{{route('media.add')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6 mx-auto">
                                            ...
                                            <input type="file" class="filepond file-upload-multiple" name="file[]" data-allow-reorder="true" data-max-file-size="3MB" data-max-files="3">


                                            <div class="flex justify-center items-end mt-12">
                                                <input type="submit" name="submit" value="Submit" class="bg-gradient-to-r from-orange-400 to-red-500 w-20 h-8 mx-3 text-white rounded text-center hover:text-yellow-400">
                                            </div>
                                        </div>
                                    </form>
...
<script>
    ...
    const fileInput = document.querySelector('.file-upload-multiple');

    // Create a FilePond instance on the file input element with allowMultiple: true
