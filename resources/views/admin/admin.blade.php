...
<head>
    ...
    <link href="{{asset('apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
                            ...
                            <div class="widget-content">
                                <div class="account-box">
                                    ...
                                    <div class="info-box">
                                        <div class="icon">
                                                <span>
                                                    <img src="{{asset('./images/money-bag.png')}}" alt="money-bag">
                                                </span>
                                        </div>
                                ...
                                <div class="meta-info">
                                    ...
                                    <div class="avatar--group">
                                        ...
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar" src="{{asset('images/profile-8.jpg')}}"/>
                                        </div>
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar" src="{{asset('images/profile-12.jpg')}}"/>
                                        </div>
                                        <div class="avatar translateY-axis">
                                            <img alt="avatar" src="{{asset('images/profile-19.jpg')}}"/>
                                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-one">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{asset('images/profile-19.jpg')}}" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                        <h6>Jimmy Turner</h6>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-card-two">
                            <div class="widget-content">
                                ...
                                <div class="media">
                                    <div class="w-img">
                                        <img src="{{asset('./images/g-8.png')}}" alt="avatar">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="card-bottom-section">
                                    ...
                                    <div class="img-group">
                                        <img src="{{asset('images/profile-19.jpg')}}" alt="avatar">
                                        <img src="{{asset('images/profile-6.jpg')}}" alt="avatar">
                                        <img src="{{asset('images/profile-8.jpg')}}" alt="avatar">
                                        <img src="{{asset('images/profile-3.jpg')}}" alt="avatar">
                                    </div>
